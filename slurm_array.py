...
np.savetxt("slurm_sample_results_1cld_"+str(it)+".csv",samp_1,delimiter =',') #saves samples and slurm array number
np.savetxt("slurm_sample_results_1cld_ev_"+str(it)+".csv",ev_1,delimiter =',') #saves log evidence values


# This script should now be ready to be sent as a part of a slurm job - check out slurm_array_job.sh now
